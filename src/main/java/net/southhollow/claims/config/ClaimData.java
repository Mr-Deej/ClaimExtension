...
public class ClaimData {
    ...
    private final FileConfiguration cfg = ClaimExtension.getInstance().getDataFile();
    ...
    private static void saveDatafile() {
        try {
            file = new File(ClaimExtension.getInstance().getDataFolder(), "data.dat");
            ClaimExtension.getInstance().getDataFile().save(file);
    ...
    public static void cleanDatafile() {
        boolean clean = false;
        final String prefix = ClaimExtension.getInstance().getDescription().getPrefix();


        if(!ClaimExtension.getInstance().getDataFile().getKeys(false).isEmpty()) {
            if(!ClaimExtension.getInstance().getDataFile().getConfigurationSection("bfc_claim_data").getKeys(false).isEmpty()) {
